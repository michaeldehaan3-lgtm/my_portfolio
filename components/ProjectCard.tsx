...
export default function ProjectCard({ project, basePath }: ProjectCardProps) {
  ...
  return (
    <article
      className={`project-card max-md:min-w-0 ${project.slug === "ponderosa" ? "project-card--ponderosa" : ""} ${project.slug === "sonic-storage" ? "project-card--sonic-storage" : ""} ${project.slug === "resonant-ground" ? "project-card--resonant-ground" : ""} ${project.slug === "braeside" ? "project-card--braeside" : ""} ${project.slug === "braeside-icon" ? "project-card--braeside-icon" : ""}`}
    >
